 ...
 * @since 2023.09.01
 */
public class TxnEquipmentStartByEqp implements ObjectExecuteService
{
	...
	public Object execute(Document recvDoc) 
	{
		...
		for ( int i = 0; i < dataList.size(); i++ ) 
		{
			...
			mapEISMsgInfo.put("MESSAGENAME", "TxnEquipmentStartByEqp");
			...
			txnInfo.setTxnComment("EISIF-TxnEquipmentStartByEqp");
