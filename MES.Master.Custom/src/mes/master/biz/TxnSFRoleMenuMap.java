...
public class TxnSFRoleMenuMap implements ObjectExecuteService
{
	/**
	 * SF_ROLEMENUMAP를 등록, 수정, 삭제 하는 트랜젝션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 */
    ...
    public Object execute(Document recvDoc)
    {
        ...
        for (int i = 0 ; i < masterData.size(); i ++)
        {
        	...
        	SF_ROLEMENUMAP dataInfo = new SF_ROLEMENUMAP();
        	// Key Value Setting
        	...
        	List<SF_ROLEMENUMAP> oRoleMenuMapList = (List<SF_ROLEMENUMAP>) dataInfo.excuteDML(SqlConstant.DML_SELECTLIST);
