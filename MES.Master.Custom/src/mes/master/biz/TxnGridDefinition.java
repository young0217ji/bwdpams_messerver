...
import mes.master.data.GRIDDEFINITION;
 ...
 * @see
 */
public class TxnGridDefinition implements ObjectExecuteService
{
	/**
	 * Grid 기준정보를 등록, 수정, 삭제 하는 트랜잭션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 * 
    ...
    public Object execute(Document recvDoc)
    {
        ...
        for (int i = 0 ; i < masterData.size(); i ++)
        {
            ...
            GRIDDEFINITION dataInfo = new GRIDDEFINITION();
            // Key Value Setting
            ...
            {
                dataInfo = (GRIDDEFINITION) dataInfo.excuteDML(SqlConstant.DML_SELECTFORUPDATE);
            }

            // Data Value Setting
            dataInfo.setGRIDNAME(dataMap.get("GRIDNAME"));
