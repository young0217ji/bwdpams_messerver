 ...
 * @see
 */
public class TxnTPPolicy implements ObjectExecuteService
{
	/**
	 * 제품기준으로 라우팅코드를 등록, 수정, 삭제 하는 트랜잭션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 * 
	 ...
	 @Override
	    public Object execute(Document recvDoc)
	    {
	        ...
	        for (int i = 0 ; i < masterData.size(); i ++)
	        {
	            ...
	            TPPOLICY dataInfo = new TPPOLICY();
	            // Key Value Setting
	            ...
	            {
	                dataInfo = (TPPOLICY) dataInfo.excuteDML(SqlConstant.DML_SELECTFORUPDATE);
	            }
