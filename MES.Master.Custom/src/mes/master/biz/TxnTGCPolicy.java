 ...
 * @see
 */
public class TxnTGCPolicy  implements ObjectExecuteService
{
	/**
	 * 제품군으로 설정된 라우팅의 공정조건을 등록, 수정, 삭제 하는 트랜잭션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 * 
	 */
	 ...
	 public Object execute(Document recvDoc)
	 {
	     ...
	     for (int i = 0 ; i < masterData.size(); i ++)
	     {
	         ...
	         TGCPOLICY dataInfo = new TGCPOLICY();
	         // Key Value Setting
	         ...
	         {
	             dataInfo = (TGCPOLICY) dataInfo.excuteDML(SqlConstant.DML_SELECTFORUPDATE);
	         }
