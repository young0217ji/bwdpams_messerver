 ...
 * @see
 */
public class DY_INSTRUMENTHISTORY {
	// Key Info
 ...
 // ITEMNAME
	...
	public void checkKeyNotNull() {
		if (this.KEYMAP.isEmpty() || this.PLANTID == null  || this.ITEMNO == null || this.TIMEKEY == null) {
			// [{1}] 다음의 필수 Key 값이 누락되었습니다.
			throw new KeyRequiredException(new Object[] { "PLANTID, ITEMNO, TIMEKEY" });
		}
	}
