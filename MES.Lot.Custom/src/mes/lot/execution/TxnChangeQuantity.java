 ...
 * @see
 */
public class TxnChangeQuantity implements ObjectExecuteService
{
	/**
	 * 해당 Lot의 수량을 Bonus or Scrap 처리하는 트랜잭션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 * 
	...
	public Object execute(Document recvDoc)
	{
		...
		for ( int i = 0; i < dataList.size(); i++ ) 
		{
			...
			validation.checkKeyNull(dataMap, new Object[] {"LOTID", "REASONCODE", "REASONCODETYPE", "CHANGEQUANTITY"});
			
			String lotID 			= dataMap.get("LOTID");
			String reasonCodeType 	= dataMap.get("REASONCODETYPE");
			String reasonCode 		= dataMap.get("REASONCODE");
			Double changeQuantity 	= ConvertUtil.Object2Double(dataMap.get("CHANGEQUANTITY"));
			...
			lotCustomService.makeScrapQuantity(lotInfo, changeQuantity, txnInfo);
		}
