 ...
 * @see
 */
public class TxnUnscrapToLocation implements ObjectExecuteService
{
	/**
	 * Lot 의 SubLot을 Unscrap 처리하는 트랜잭션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 * 
	...
	public Object execute(Document recvDoc)
	{
		...
		lotCustomService.makeScrapQuantity(lotInfo, scrapQuantity, mapSubLot, txnInfo);
