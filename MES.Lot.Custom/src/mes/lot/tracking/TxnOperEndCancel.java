 ...
 * @see
 */
public class TxnOperEndCancel implements ObjectExecuteService
{
	/**
	 * 공정종료를 취소하는 트랜잭션 실행
	 * 
	...
	public Object execute(Document recvDoc)
	{
		...
		for ( int i = 0; i < dataList.size(); i++ ) 
		{
			...
			operationService.processEndCancel(lotID, processID, processSequence, routeRelationSequence, txnInfo);
		}
