 ...
 * @see
 */
public class TxnInspection implements ObjectExecuteService
{
	/**
	 * 
	 * 
	...
	public Object execute(Document recvDoc)
	{
		...
		for ( int i = 0; i < dataList.size(); i++ ) 
		{
			...
			recipeCustomService.recipeProcess(lotID, processID, processSequence, routeRelationSequence, recipeID, recipeSequence, 
