 ...
 * @see
 */
public class TxnTrackingStart implements ObjectExecuteService
{
	/**
	 * Durable (or Carrier) 단위로 생산시작하는 트랜잭션 실행
	 * 
	 * @param recvDoc
	 * @return Object
	 * 
	...
	public Object execute(Document recvDoc)
	{
		...
		if ( dataList.size() > 0 ) 
		{
			...
			for ( int i = 0; i < listLotInfo.size(); i++ )
			{
				...
				lotCustomService.startLot(lotInfo.getKeyLOTID(), txnInfo);
			}
		}
