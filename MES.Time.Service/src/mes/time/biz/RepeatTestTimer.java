...
public class RepeatTestTimer implements Job 
{
	private static final transient Logger logger = LoggerFactory.getLogger(RepeatTestTimer.class);
	
	public void executeRepeatTestTimer() throws Exception
	{		
		//Log
		logger.info("########## RepeatTestTimer Execute ##########");
