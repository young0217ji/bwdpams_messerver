...
public class WORKGROUPUSERMAP
{
    ...
    {
        if (this.KEYMAP.isEmpty() || this.PLANTID == null || this.WORKGROUPID == null || this.USERID == null)
        {
            // [{1}] 다음의 필수 Key 값이 누락되었습니다.
            throw new KeyRequiredException(new Object [] {"PLANTID, WORKGROUPID, USERID"});
        }
    }
