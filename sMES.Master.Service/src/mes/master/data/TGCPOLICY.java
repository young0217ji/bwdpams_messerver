...
public class TGCPOLICY
{
    ...
    {
        if (this.KEYMAP.isEmpty() || this.PLANTID == null || this.PRODUCTGROUPID == null || this.COMPOSITIONID == null || this.RECIPEPARAMETERID == null)
        {
            // [{1}] 다음의 필수 Key 값이 누락되었습니다.
            throw new KeyRequiredException(new Object [] {"PLANTID, PRODUCTGROUPID, COMPOSITIONID, RECIPEPARAMETERID"});
        }
    }
